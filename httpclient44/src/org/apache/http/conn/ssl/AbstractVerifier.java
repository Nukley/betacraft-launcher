...
public abstract class AbstractVerifier implements X509HostnameVerifier {
    ...
    public final void verify(final String host, final String[] cns,
        ...
        final String normalizedHost = InetAddressUtils.isIPv6Address(host) ?
                DefaultHostnameVerifier.normaliseAddress(host.toLowerCase(Locale.ENGLISH)) : host;
    ...
    private static boolean matchIdentity(final String host, final String identity, final boolean strict) {
        ...
        final String normalizedHost = host.toLowerCase(Locale.ENGLISH);
        final String normalizedIdentity = identity.toLowerCase(Locale.ENGLISH);
