...
final class NTLMEngineImpl implements NTLMEngine {
    ...
    final String getResponseFor(final String message, final String username, final String password,
            final String host, final String domain) throws NTLMEngineException, UnsupportedEncodingException {
     ...
     * @throws UnsupportedEncodingException 
     */
    String getType1Message(final String host, final String domain) throws NTLMEngineException, UnsupportedEncodingException {
    ...
    String getType3Message(final String user, final String password, final String host, final String domain,
            ...
            throws NTLMEngineException, UnsupportedEncodingException {
