...
public class UrlEncodedFormEntity extends StringEntity {
    ...
    public UrlEncodedFormEntity (
        ...
        final Charset charset) throws UnsupportedCharsetException, UnsupportedEncodingException {
        super(URLEncodedUtils.format(parameters,
     ...
     */
    public UrlEncodedFormEntity (
        final Iterable <? extends NameValuePair> parameters) throws UnsupportedCharsetException, UnsupportedEncodingException {
