...
public class StringEntity extends AbstractHttpEntity implements Cloneable {
     ...
     * @since 4.2
     */
    public StringEntity(final String string, final ContentType contentType) throws UnsupportedCharsetException, UnsupportedEncodingException {
        super();
        ...
        this.content = string.getBytes(charset.displayName());
        if (contentType != null) {
    ...
    public StringEntity(final String string, final String charset)
            throws UnsupportedCharsetException, UnsupportedEncodingException {
     ...
     * @since 4.2
     */
    public StringEntity(final String string, final Charset charset) throws UnsupportedCharsetException, UnsupportedEncodingException {
        this(string, ContentType.create(ContentType.TEXT_PLAIN.getMimeType(), charset));
    }
