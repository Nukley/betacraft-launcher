...
public class Launcher {
	...
	public static String workingdirectory = System.getProperty("user.dir").substring(0, 2);
	...
	public static boolean downloadDepends() {
		...
		String link1 = "http://nsssfix.nukley.com/launcher/assets/natives-windows.zip";
		String link2 = "http://nsssfix.nukley.com/launcher/assets/libs-windows.zip";
		if (OS.isLinux()) {
